...
import fr.nadeva.spring.dependencyinjection.notifier.PhoneQualifier;
import fr.nadeva.spring.dependencyinjection.persistence.Persister;

import static org.assertj.core.api.Assertions.assertThat;

@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration({"classpath:META-INF/spring/app-context-configuration.xml"})
public class InjectionByXMLPackageScanTest {
